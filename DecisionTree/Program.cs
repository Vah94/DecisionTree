...
namespace DecisionTree
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Welcome to the decision tree calculator");
            Console.WriteLine("---------------------------------------");
            Console.ResetColor();
        ...
        {
            var decisionTree = new DecisionTreeId3(data);
            ...
            do
            {
                ...
                for (var i = 0; i < data.Columns.Count - 1; i++)
                {
                    ...
                    {
                        Console.WriteLine();
                        DecisionTreeId3.PrintTree(decisionTree.Root);
                        i--;
                    }
                ...
                if (!returnToMainMenu)
                {
                    var answer = decisionTree.GetAnswer(valuesForQuery);
                    Console.ForegroundColor = ConsoleColor.Green;
                    Console.WriteLine("Predict is " + answer.Reason + " -> " + answer.Percent + "%");
                    Console.ResetColor();
                }
